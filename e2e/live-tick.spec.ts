...
// one-off manual check. Asserts against SymbolCardGrid's price cell, which
// genuinely re-renders on SSE `quote` events (lib/sse.ts) — same
// data-testid contract the table this replaced (MarketTable) used, kept
// deliberately stable across the mockups/v3 redesign.
